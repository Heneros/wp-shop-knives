...
<?php } else {
	$date_format = get_comment_date('d-m-Y');
?>
	<div class="meta">
		...
		?>
		<time class="date woocommerce-review__published-date" datetime="<?php echo esc_attr(get_comment_date('c')); ?>"><?php echo apply_filters('woocommerce_date_format', $date_format); ?></time>
	</div>
