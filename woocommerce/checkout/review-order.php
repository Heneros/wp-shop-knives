...
<table class="shop_table woocommerce-checkout-review-order-table p-30">
	...
	<tbody>
		...
		foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
			...
			$review_product_id = $_product->get_id();
			$image_url = wp_get_attachment_url(get_post_thumbnail_id($review_product_id), '');
		...
		?>
				<tr class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'card-item', $cart_item, $cart_item_key)); ?>">
					...
					<td class="product-quantity" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>" style="pointer-events: none">
						<?php
